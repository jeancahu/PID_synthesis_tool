...
if PI_Ms_1_4_enable
    ...
    fprintf(file_erridx_id, ',\n\t"IAE_D_PI_1_4": %.20f', IAE_d);     % Disturbance error
    fprintf(file_erridx_id, ',\n\t"IAE_T_PI_1_4": %.20f', TOTAL_IAE); % Total error
end
...
if PI_Ms_2_0_enable
    ...
    fprintf(file_erridx_id, ',\n\t"IAE_D_PI_2_0": %.20f', IAE_d);     % Disturbance error
    fprintf(file_erridx_id, ',\n\t"IAE_T_PI_2_0": %.20f', TOTAL_IAE); % Total error
end
...
if PID_Ms_1_4_enable
    ...
    fprintf(file_erridx_id, ',\n\t"IAE_D_PID_1_4": %.20f', IAE_d);     % Disturbance error
    fprintf(file_erridx_id, ',\n\t"IAE_T_PID_1_4": %.20f', TOTAL_IAE); % Total error
end
...
if PID_Ms_2_0_enable
    ...
    fprintf(file_erridx_id, ',\n\t"IAE_D_PID_2_0": %.20f', IAE_d);     % Disturbance error
    fprintf(file_erridx_id, ',\n\t"IAE_T_PID_2_0": %.20f', TOTAL_IAE); % Total error
end
